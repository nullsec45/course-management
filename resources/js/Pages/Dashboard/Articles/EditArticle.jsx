...
import { AlertCircleIcon, Loader2, Save, FileEdit, CircleXIcon, X, Image as ImageIcon } from 'lucide-react';
...
export default function EditArticle({ auth, article, categories }) {
    const [previewUrl, setPreviewUrl] = useState(article.media?.[0]?.original_url || null); 
    ...
    const { data, setData, post, processing, errors } = useForm({
        ...
        thumbnail: article.media.original_url || null,
    });
    ...
    function onSubmit(e) {
        e.preventDefault();
        post(route('dashboard.articles.update', article.id));
    }
